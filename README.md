...
* [Dino](https://github.com/dino/dino) ⭐ 2,489 | 🐛 684 | 🌐 Vala | 📅 2026-08-21 - Modern Jabber/XMPP Client using GTK+/Vala.
...
* [MongooseIM](https://github.com/esl/MongooseIM) ⭐ 1,757 | 🐛 37 | 🌐 Erlang | 📅 2026-09-18 - XMPP server at the core of an Instant Messaging platform
...
* [xmpp.js](https://github.com/xmppjs/xmpp.js) ⭐ 2,277 | 🐛 33 | 🌐 JavaScript | 📅 2026-09-03 - XMPP for JavaScript.
* [SleekXMPP](https://github.com/fritzy/SleekXMPP) ⚠️ Archived - Python 2.6+/3.1+ XMPP Library.
* [Tigase Swift](https://github.com/tigaseinc/tigase-swift) ⭐ 78 | 🐛 9 | 🌐 Swift | 📅 2026-09-14 - Tigase Swift XMPP client library
...
* [commitbot](https://github.com/metajack/commitbot) ⭐ 52 | 🐛 0 | 🌐 Python | 📅 2013-09-13 - XMPP bot that notifies MUCs of git repository commits.
* [issuebot](https://github.com/malexmave/issuebot) ⭐ 3 | 🐛 6 | 🌐 Python | 📅 2013-10-11 - XMPP bot that notifies MUCs of changes to Issues on a GitHub-Project.
...
* [Movim](https://github.com/movim/movim) ⭐ 2,056 | 🐛 45 | 🌐 PHP | 📅 2026-09-18 - Distributed social network built on top of XMPP.
...
* [The Jabber Spam Fighting Manifesto](https://github.com/ge0rg/jabber-spam-fighting-manifesto/) ⭐ 34 | 🐛 5 | 📅 2021-11-26 - Federated Server Policies against the spam.
