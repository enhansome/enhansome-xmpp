...
* [Dino](https://github.com/dino/dino) ⭐ 2,485 | 🐛 682 | 🌐 Vala | 📅 2026-08-21 - Modern Jabber/XMPP Client using GTK+/Vala.
...
* [MongooseIM](https://github.com/esl/MongooseIM) ⭐ 1,751 | 🐛 31 | 🌐 Erlang | 📅 2026-09-03 - XMPP server at the core of an Instant Messaging platform
...
* [Movim](https://github.com/movim/movim) ⭐ 2,050 | 🐛 44 | 🌐 PHP | 📅 2026-09-03 - Distributed social network built on top of XMPP.
