...
* [Dino](https://github.com/dino/dino) ⭐ 2,491 | 🐛 684 | 🌐 Vala | 📅 2026-08-21 - Modern Jabber/XMPP Client using GTK+/Vala.
...
* [MongooseIM](https://github.com/esl/MongooseIM) ⭐ 1,759 | 🐛 37 | 🌐 Erlang | 📅 2026-09-18 - XMPP server at the core of an Instant Messaging platform
...
* [Movim](https://github.com/movim/movim) ⭐ 2,056 | 🐛 44 | 🌐 PHP | 📅 2026-09-19 - Distributed social network built on top of XMPP.
