...
* [Dino](https://github.com/dino/dino) ⭐ 2,486 | 🐛 684 | 🌐 Vala | 📅 2026-08-21 - Modern Jabber/XMPP Client using GTK+/Vala.
...
* [MongooseIM](https://github.com/esl/MongooseIM) ⭐ 1,753 | 🐛 35 | 🌐 Erlang | 📅 2026-09-08 - XMPP server at the core of an Instant Messaging platform
...
* [Movim](https://github.com/movim/movim) ⭐ 2,053 | 🐛 45 | 🌐 PHP | 📅 2026-09-07 - Distributed social network built on top of XMPP.
